...
<title>{{ Cantidad_Mensajes_Sin_Ver > 0 &&   Cantidad_Mensajes_Sin_Ver+' '+'Mensaje Nuevo' || dato.AOBJ_Datos_Usuario[0].Nombre_Usuario}} | Modulo Productos</title>
...
<section id="SC_Contenido_Pagina_Productos" ng-init="FN_Listar_Productos(1 ,null );FN_Listar_Categoria();FN_Listar_Promocion()" ng-controller="Controlador_Registro_Producto">
            ...
            <div ng-class="{Barra_Izquierda_Oculto:BL_Ocultar_Barra_Izquierda == true, BL_Ocultar_Barra_Izquierda:BL_Ocultar_Barra_Derecha == true}" class="Grid_Contenedor Base-40 cross_start CL_CONT_Tablero">
              <div class="CL_Cabezera_Tablero_Trabajo Grid_Contenedor Base-100 relative">
                <div class="Grid_Item Base-auto">
                  <div class="margin_left-50 CL_TXT_Texto_5 icon-cube CL_TXT_Gris CL_TXT_Icon_Gris">Productos</div>
                ...
                <div class="Grid_Contenedor Base-90 CL_Informacion_Tablero_1 cross_start">
                  ...
                  <section ng-show="BL_Registrar_Producto == true" class="Grid-Item ng_show Base-100 abcenter">
                    <div class="CL_Alerta_5 relative Padding-5">
                      <div class="CL_TXT_Texto_2 CL_TXT_Gris">Registro de un producto</div>
                      <div ng-click="BL_Registrar_Producto = false" class="CL_Eliminar_1_1"></div>
                    </div>
                    <form id="FORM_Registro" ng-class="{CL_Registro_Base_50:BL_Ocultar_Barra_Izquierda == false, CL_Registro_Base_100:BL_Ocultar_Barra_Derecha == false}" name="Form_Registro_Producto" ng-submit="Registrar_Producto(RP)" class="Grid_Contenedor Padding-tablet">
                      <div class="Grid_Item Base-100 CL_Form_Registro_Producto">
                        ...
                        <input id="Precio_Producto" max="999999" min="1" type="number" name="Precio_Producto" ng-model="RP.Precio_Producto" placeholder="Precio unitario del producto" required="required" class="Input_Estilo_1"/>
                        ...
                        <input id="Cantidad_Maxima" max="100" min="1" type="number" name="Cantidad_Maxima" ng-model="RP.Cantidad_Maxima" placeholder="Cantidad maxima del producto" required="required" class="Input_Estilo_1"/>
                        ...
                        <input id="Cantidad_Minima" max="100" min="1" type="number" name="Cantidad_Minima" ng-model="RP.Cantidad_Minima" placeholder="Cantidad minima del producto" required="required" class="Input_Estilo_1"/>
                  ...
                  <div ng-show="BL_Registrar_Producto == false &amp;&amp; Edicion_Datos_Productos == false" class="CL_Alerta_5 Padding-5"> 
                    <p class="CL_TXT_Texto_2 CL_TXT_Gris">Selecciona un producto para ver su informaci&oacute;n</p>
                  </div>
                  ...
                  <form ng-class="{CL_Registro_Base_50:BL_Ocultar_Barra_Izquierda == false, CL_Registro_Base_100:BL_Ocultar_Barra_Derecha == false}" name="Form_Productos_Ediccion" ng-show="Edicion_Datos_Productos == true" class="Grid_Contenedor abcenter">
                    <div class="Grid_Contenedor column CL_Edicicion_Producto">
                      <!--/----->
                      <div class="Grid_Contenedor">
                        <label class="CL_TXT_Texto_2 CL_TXT_Gris">Nombre producto</label>
                      ...
                      <!--/------>
                      <div class="Grid_Contenedor">
                        <label class="CL_TXT_Texto_2 CL_TXT_Gris">Precio</label>
                      ...
                      <!--/------>
                      <div class="Grid_Contenedor">
                        <label class="CL_TXT_Texto_2 CL_TXT_Gris">Descripci&oacute;n</label>
                      ...
                      <!--/------>
                      <div class="Grid_Contenedor">
                        <label class="CL_TXT_Texto_2 CL_TXT_Gris">Cantidad minima</label>
                      ...
                      <!--/------->
                      <div class="Grid_Contenedor">
                        <label class="CL_TXT_Texto_2 CL_TXT_Gris">Cantidad maxima</label>
                      ...
                      <!--/------->
                      <div class="Grid_Contenedor">
                        <label class="CL_TXT_Texto_2 CL_TXT_Gris">Url imagen produto</label>
                      ...
                      <!--/---->
                      <div class="Grid_Contenedor">
                        <label class="CL_TXT_Texto_2 CL_TXT_Gris">Categoria</label>
                      ...
                      <!--/----->
                      <div class="Grid_Contenedor">
                        <label class="CL_TXT_Texto_2 CL_TXT_Gris">Estado</label>
            ...
            <div ng-class="{Barra_Derecho_Oculto:BL_Ocultar_Barra_Derecha == true,Barra_Derecho_Desplegado: BL_Ocultar_Barra_Izquierda == true}" class="Grid_Contenedor Base-60 cross_start CL_CONT_Tablero_Trabajo_2">
              <div class="CL_Cabezera_Tablero_Trabajo Grid_Contenedor Base-100 border_bottom_1">
                ...
                <div class="Grid_Item Base-100 Grid_Contenedor abcenter">
                  <div class="CL_TXT_Texto_4 CL_TXT_Gris margin_left-50 icon-cube CL_TXT_Icon_Gris"></div>
                </div>
              </div>
                  ...
                  <div class="CL_Alerta_5 Grid_Contenedor Padding-5">
                    <div class="Grid_Item Base-100 Grid_Contenedor abcenter">
                      <div class="Grid_Item Base-30">
                        <div ng-click="FN_Listar_Productos(1 ,null )" class="Btn_Estilo_5">Consultar productos</div>
                      </div>
                      <div class="Grid_Item Base-30">
                  ...
                  <div class="Grid_Contenedor">
                    <section class="ng_show Base-100">
                        ...
                        <table ng-init="BL_Activar_Edicion=false">
                          ...
                          <tbody>
                            <tr dir-paginate="ListarProductos in AOBJ_Listar_Productos  | filter:Buscar | itemsPerPage: pageSize" current-page="currentPage" class="ng_repeat_amiacion_1">
                              ...
                              <td class="CL_Tbl_Icon">
                                <div ng-click=" FN_Editar_Datos_Producto(ListarProductos.PK_ID_Producto)" class="icon-lapiz CL_TXT_Pri_Btn relative"><span class="CL_TXT_Info_Btn">Editar</span></div>
                              </td>
                              <td class="CL_Tbl_Icon">
                                <div ng-click=" FN_Eliminar_Producto(ListarProductos.PK_ID_Producto)" class="icon-cancelar2 CL_TXT_Pri_Btn relative"><span class="left-30_30 CL_TXT_Info_Btn">Eliminar</span></div>
                              </td>
                            </tr>
                          </tbody>
                        </table>
                      ...
                      <div ng-show="(AOBJ_Listar_Productos |filter:Buscador_Productos:ListarProductos.Nombre_Producto).length == 0" class="CL_Alerta_5 ng_repeat_anim1 Grid_Contenedor abcenter">
                        <div class="CL_TXT_Texto_3 CL_TXT_Gris Base-20 Grid_Item abcenter Padding-10">No se han encontrado productos</div>
                      </div>
                    </section>
                  </div>
                </div>
            ...
            <div class="Grid_Item Base-100 Grid_Contenedor column">
              <div ng-repeat="Promociones in AOBJ_Lista_Promociones_Producto" class="CL_Promociones_Listadas Grid_Contenedor reverse">
                <div class="Grid_Item Base-60 Grid_Contenedor abcenter">
                  <label class="CL_TXT_Texto_3 CL_TXT_Gris">{{Promociones.Nombre_Promocion}}</label>
                </div>
                <div class="Grid_Item Base-30">
            ...
            <div class="Grid_Item Base-100 Grid_Contenedor column">
              <div ng-repeat="Promociones in AOBJ_Lista_Promociones" class="CL_Promociones_Listadas Grid_Contenedor reverse">
                <div class="Grid_Item Base-70 Grid_Contenedor abcenter">
                  <label class="CL_TXT_Texto_3 CL_TXT_Gris Grid_Contenedor abcenter">{{Promociones.Nombre_Promocion}}</label>
                </div>
                ...
                <div ng_show="BL_Dtll_Promocion == true" class="CL_Alerta_1 CL_Dll_Promocion Grid_Item Base-100 ng_show">
                  <p class="CL_TXT_Texto_2 CL_TXT_Gris">{{Promociones.Descripcion}}</p>
                </div>
              </div>
            </div>
          </div>
