...
<title>{{ Cantidad_Mensajes_Sin_Ver > 0 &&   Cantidad_Mensajes_Sin_Ver+' '+'Mensaje Nuevo' || dato.AOBJ_Datos_Usuario[0].Nombre_Usuario}} | Guia proyecto</title>
<link rel="stylesheet" href="<?php echo URL;?>public/css/Templates/Administracion/Guia_Proyecto/Guia_Proyecto.css"/>
<!--sesion Estructura-->
<main id="CONT_Principal_Guia" ng-controller="Controlador_Guia_Proyecto" ng-init="FN_Ver_Elemento_Guia(7)">
  <section id="SC_Guia_Estructura" ng-if="Estructura == true" class="ng_show Grid_Contenedor Base-100 web-90 abcenter">
  ...
  <!--sesion sass-->
  <section id="SC_Sass" ng-if="Sass == true" class="ng_show Grid_Contenedor Base-100 web-90 abcenter">
    <div id="CONT_Contenedor_Invisible_Header"></div>
    <div id="CONT_Titulo">
  ...
  <!--sesion angular-->
  <section id="SC_Sass" ng-if="Angular == true" class="ng_show Grid_Contenedor Base-100 web-90 abcenter">
    <div id="CONT_Contenedor_Invisible_Header"></div>
    <div id="CONT_Titulo">
  ...
  <!--sesion Html-->
  <section id="SC_Sass" ng-if="Html == true" class="ng_show Grid_Contenedor Base-100 web-90 abcenter">
    <div id="CONT_Contenedor_Invisible_Header"></div>
    <div id="CONT_Titulo">
  ...
  <section id="SC_Sass" ng-if="DB == true" class="ng_show Grid_Contenedor Base-100 web-90 abcenter">
    <div id="CONT_Contenedor_Invisible_Header"></div>
    <div id="CONT_Titulo">
  ...
  <section id="SC_Sass" ng-if="Grid == true" class="ng_show">
    <div id="CONT_Contenedor_Invisible_Header"></div>
    <div id="CONT_Titulo">
      <p class="Icono1 icon-design">Grid layout</p>
    </div>
    <div id="CONT_Estructura_Carpetas">
      <div id="CONT_Contenido" class="Grid_Contenedor abcenter Base-100 web-90">
        <div class="CL_Bloques Grid_Contenedor">
          <li class="CL_Diseno">
            <p class="CL_Titulo_Contenedor icon-design">Grid<span>Layout</span></p>
  ...
  <section id="SC_Sass" ng-if="Diseno == true" class="ng_show">
    <div id="CONT_Contenedor_Invisible_Header"></div>
    <div id="CONT_Titulo">
      <p class="Icono1 icon-design">UI ELEMENT</p>
    </div>
    <div id="CONT_Estructura_Carpetas">
      <div id="CONT_Contenido" class="Grid_Contenedor abcenter Base-100 web-90">
        <div class="CL_Bloques Grid_Contenedor">
          <li class="CL_Diseno">
            <p class="CL_Titulo_Contenedor icon-design">UI<span>Element</span></p>
            <p class="CL_Alerta_5 Padding-10 CL_Titulo_Grid">Elementos generales</p>
          </li>
          <li class="CL_Diseno">
            <p class="icon-design CL_Txt_1">Botones</p>
            <div class="Grid_Contenedor Base-50 Grid_Item"><a class="Btn_Estilo_1 icon-login">Boton</a><a class="Btn_Estilo_2 icon-login">Boton</a><a class="Btn_Estilo_3 icon-login">Boton</a><a class="Btn_Estilo_4 icon-login">Boton</a><a class="Btn_Estilo_5 icon-login">Boton</a><a class="Btn_Estilo_6 icon-login">Boton</a><a class="Btn_Estilo_7 icon-login">Boton</a></div>
            <div class="Grid_Contenedor Base-50 Grid_Item"><a class="Btn_Estilo_1_1 icon-login">Boton</a><a class="Btn_Estilo_2_2 icon-login">Boton</a><a class="Btn_Estilo_3_3 icon-login">Boton</a><a class="Btn_Estilo_4_4 icon-login">Boton</a><a class="Btn_Estilo_5_5 icon-login">Boton</a><a class="Btn_Estilo_6_6 icon-login">Boton</a><a class="Btn_Estilo_7_7 icon-login">Boton</a></div>
            <div class="CL_Alerta_Codigo Padding-10 Base-100 tablet-50 Grid_Item">
              <div class="CL_TXT_Texto_4 CL_TXT_Gris CL_TXT_Texto_Bold">Codigo para crear un boton</div>
              <pre lang="pung"><code>a.Btn_Estilo_1.icon-login Boton<br/>a.Btn_Estilo_2.icon-login Boton<br/>a.Btn_Estilo_3.icon-login Boton<br/>a.Btn_Estilo_4.icon-login Boton<br/>a.Btn_Estilo_5.icon-login Boton<br/>a.Btn_Estilo_6.icon-login Boton<br/>a.Btn_Estilo_7.icon-login Boton</code></pre>
            </div>
            <div class="CL_Alerta_Codigo Padding-10 Base-100 tablet-50 Grid_Item">
              <div class="CL_TXT_Texto_4 CL_TXT_Gris CL_TXT_Texto_Bold">Codigo para crear un boton</div>
              <pre lang="pung"><code>a.Btn_Estilo_1_1.icon-login Boton<br/>a.Btn_Estilo_2_2.icon-login Boton<br/>a.Btn_Estilo_3_3.icon-login Boton<br/>a.Btn_Estilo_4_4.icon-login Boton<br/>a.Btn_Estilo_5_5.icon-login Boton<br/>a.Btn_Estilo_6_6.icon-login Boton<br/>a.Btn_Estilo_7_7.icon-login Boton</code></pre>
            </div>
          </li>
          <li class="CL_Diseno">
            <p class="icon-design CL_Txt_1">Radio botton
              <div class="Grid_Contenedor">
                <section id="SC_Genero" class="ng_show Grid_Contenedor Base-25">
              ...
              <div class="Grid_Contenedor cross_start">
                <div class="CL_Alerta_Codigo Padding-10 Base-100 tablet-50 Grid_Item">
                  <div class="CL_TXT_Texto_4 CL_TXT_Gris CL_TXT_Texto_Bold">Codigo para crear un boton tipo radio botton</div>
                  <pre lang="pung"><code>
                      <div class="CL_TXT_Texto_2 CL_TXT_Gris CL_TXT_Texto_Bold">Estilo 1</div>input#ID_INPUT_Hombre.Btn_Radio(name="sexo"  type="radio"  )
label.RadioBtn_1(for="ID_INPUT_Hombre") Hombre<br/>input#ID_INPUT_Mujer.Btn_Radio(name="sexo"  type="radio"  )
label.RadioBtn_1(for="ID_INPUT_Mujer") Mujer<br/>
                      <div class="CL_TXT_Texto_2 CL_TXT_Gris CL_TXT_Texto_Bold">Estilo 3</div>input#ID_INPUT_Hombre3.Btn_Radio(name="sexo"  type="radio"  )
label.RadioBtn_3(for="ID_INPUT_Hombre3") Hombre<br/>input#ID_INPUT_Mujer3.Btn_Radio(name="sexo"  type="radio"  )
label.RadioBtn_3(for="ID_INPUT_Mujer3") Mujer</code></pre>
                </div>
                <div class="CL_Alerta_Codigo Padding-10 Base-100 tablet-50 Grid_Item">
                  <div class="CL_TXT_Texto_4 CL_TXT_Gris CL_TXT_Texto_Bold">Codigo para crear un boton tipo radio botton</div>
                  <div class="CL_TXT_Texto_2 CL_TXT_Gris CL_TXT_Texto_Bold">Estilo 2
                    <pre lang="pung"><code>input#ID_INPUT_Hombre2.Btn_Radio(name="sexo"  type="radio"  )
label.RadioBtn_2(for="ID_INPUT_Hombre2") Hombre<br/>input#ID_INPUT_Mujer2.Btn_Radio(name="sexo"  type="radio"  )
label.RadioBtn_2(for="ID_INPUT_Mujer2") Mujer</code></pre>
                  </div>
                </div>
              </div>
            </p>
          ...
          <li class="CL_Diseno">
            ...
            <div class="Grid_Contenedor cross_start">
              <div class="Grid_Contenedor Grid_Item Base-100 tablet-50">
                <select name="" value="Opcion 1" required="required" class="Select_1">
                  <option value="Opcion 1">Opcion 1</option>
                  <option value="Opcion 2">Opcion 2</option>
                </select>
                <select name="" value="Opcion 1" required="required" class="Select_2">
                  <option value="Opcion 1">Opcion 1</option>
                  <option value="Opcion 2">Opcion 2</option>
                </select>
                <select name="" value="Opcion 1" required="required" class="Select_3">
                  <option value="Opcion 1">Opcion 1</option>
                  <option value="Opcion 2">Opcion 2</option>
                </select>
              </div>
              <div class="Grid_Contenedor cross_start Base-100 tablet-50">
                <div class="CL_Alerta_Codigo Padding-10 Grid_Item">
                  <div class="CL_TXT_Texto_4 CL_TXT_Gris CL_TXT_Texto_Bold">Codigo para crear un select</div>
                  <pre lang="pung"><code>select.Select_1(name="" value="Opcion 1" required)
	option(value="Opcion 1") Opcion 1
	option(value="Opcion 2") Opcion 2<br/>select.Select_2(name="" value="Opcion 1" required)
	option(value="Opcion 1") Opcion 1
	option(value="Opcion 2") Opcion 2<br/>select.Select_3(name="" value="Opcion 1" required)
	option(value="Opcion 1") Opcion 1
	option(value="Opcion 2") Opcion 2</code></pre>
                </div>
              </div>
            </div>
          </li>
            ...
            <div class="Grid_Contenedor cross_start">
              <div class="Grid_Contenedor Grid_Item Base-100 tablet-50">
                <div class="Btn_Circular_1">
                  <p class="icon-chat"></p>
                  <p class="CL_TXT_Info_Btn">Texto mensaje</p>
                </div>
              ...
              <div class="Grid_Contenedor cross_start Base-100 tablet-50">
                <div class="CL_Alerta_Codigo Padding-10 Grid_Item">
                  <div class="CL_TXT_Texto_4 CL_TXT_Gris CL_TXT_Texto_Bold">Codigo para crear un boton circular flotante o fijo</div>
                  <div class="CL_TXT_Texto_1">!Nota¡: Hay que agregarle al contenedor en que se encuentre el boton un Position:realitve, para que el boton tome como posicion de referencia la del contenedor en que se encuentra, si no se hace esto, el boton se saldra del contenedor.</div>
                  <pre lang="pung"><code>.Btn_Circular_1
	p.icon-chat
	p.CL_TXT_Info_Btn Texto mensaje<br/>.Btn_Circular_2
	p.icon-chat
	p.CL_TXT_Info_Btn Texto mensaje<br/>.Btn_Circular_3
	p.icon-chat
	p.CL_TXT_Info_Btn Texto mensaje</code></pre>
                </div>
              </div>
            </div>
          </li>
            ...
            <div class="Grid_Contenedor cross_start"> 
              <div class="Grid_Item Base-100 tablet-50">
                <div class="CL_Contenedor_Buscador">
                  <input id="Buscar" type="text" name="" placeholder="Buscar " ng-model="Buscar_Ejemplo" class="CL_Buscar"/>
                  <label for="Buscar" class="icon-buscar CL_Icono_Buscar"></label>
                </div>
              </div>
              <div class="Grid_Contenedor cross_start Grid_Item Base-100 tablet-50">
                <div class="CL_Alerta_Codigo Padding-10 Grid_Item">
                  <div class="CL_TXT_Texto_4 CL_TXT_Gris CL_TXT_Texto_Bold">Codigo para crear un buscador</div>
                  <pre lang="pung"><code>.CL_Contenedor_Buscador
	input.CL_Buscar#Buscar(type="text", name="" placeholder="Buscar" ng-model="Buscar_Ejemplo")
	label.icon-buscar.CL_Icono_Buscar(for="Buscar")</code></pre>
                </div>
              </div>
            </div>
          </li>
          <li class="CL_Diseno">
            ...
            <div class="Grid_Contenedor cross_start">
              <div class="Grid_Contenedor Grid_Item Base-100 tablet-50 column"><a class="CL_TXT_Enlace_1">Enlace tipo 1</a><a class="CL_TXT_Enlace_2">Enlace tipo 2</a><a class="CL_TXT_Enlace_3">Enlace tipo 3</a><a class="CL_TXT_Enlace_4">Enlace tipo 4</a><a class="CL_TXT_Enlace_5">Enlace tipo 5</a><a class="CL_TXT_Enlace_6">Enlace tipo 6</a></div>
              <div class="Grid_Contenedor cross_start Grid_Item Base-100 tablet-50">
                <div class="CL_Alerta_Codigo Padding-10 Grid_Item">
                  <div class="CL_TXT_Texto_4 CL_TXT_Gris CL_TXT_Texto_Bold">Codigo para crear un texto con efecto de enlace</div>
                  <pre lang="pung"><code>a.CL_TXT_Enlace_1 Enlace tipo 1<br/>a.CL_TXT_Enlace_2 Enlace tipo 2<br/>a.CL_TXT_Enlace_3 Enlace tipo 3<br/>a.CL_TXT_Enlace_4 Enlace tipo 4<br/>a.CL_TXT_Enlace_5 Enlace tipo 5<br/>a.CL_TXT_Enlace_6 Enlace tipo 6</code></pre>
                </div>
              </div>
            </div>
          </li>
          <li class="CL_Diseno">
            ...
            <div class="Grid_Contenedor cross_start">
              <div class="Grid_Contenedor Grid_Item Base-100 tablet-50 column"><a class="CL_TXT_Texto_1">Texto tipo 1</a><a class="CL_TXT_Texto_2 CL_TXT_Gris">Texto tipo 2</a><a class="CL_TXT_Texto_3 CL_TXT_Gris">Texto tipo 3</a><a class="CL_TXT_Texto_4 CL_TXT_Gris">Texto tipo 4</a><a class="CL_TXT_Texto_5">Texto tipo 5</a><a class="CL_TXT_Texto_6">Texto tipo 6</a></div>
              <div class="Grid_Contenedor cross_start Grid_Item Base-100 tablet-50">
                <div class="CL_Alerta_Codigo Padding-10 Grid_Item">
                  <div class="CL_TXT_Texto_4 CL_TXT_Gris CL_TXT_Texto_Bold">Codigo para crear un texto</div>
                  <pre lang="pung"></pre><code>a.CL_TXT_Texto_1 Texto tipo 1<br/>a.CL_TXT_Texto_2.CL_TXT_Gris Texto tipo 2<br/>a.CL_TXT_Texto_3.CL_TXT_Gris Texto tipo 3<br/>a.CL_TXT_Texto_4.CL_TXT_Gris Texto tipo 4<br/>a.CL_TXT_Texto_5 Texto tipo 5<br/>a.CL_TXT_Texto_6 Texto tipo 6</code>
                </div>
              </div>
            </div>
          </li>
              ...
              <div class="Tabla_Estilo_1">
                <table>
                  ...
                  <div class="Grid_Contenedor abcenter CON_Paginacion">
                    ...
                    <dir-pagination-controls boundary-links="true" pagination-id="Ejemplo_Paginacion" class="Base-45 cross_end Grid_Contenedor">
                  ...
                  <tbody>
                    <tr dir-paginate="Ejemplo in Ejemplo_Array  | itemsPerPage: pageSize" current-page="currentPage" pagination-id="Ejemplo_Paginacion">
                      <td class="CL_TXT_Texto_3 CL_TXT_Gris">{{Ejemplo.NUM_ID_Mensaje}}</td>
                      <td class="CL_TXT_Texto_3 CL_TXT_Gris">{{Ejemplo.TXT_Nombre_Usuario}}</td>
                      <td class="CL_TXT_Texto_3 CL_TXT_Gris">{{Ejemplo.TXT_Mensaje}}</td>
                      <td class="CL_TXT_Texto_3 CL_TXT_Gris">{{Ejemplo.DATE_Hora_Envio}}</td>
                    </tr>
                  </tbody>
                </table>
              </div>
            </div>
            <div class="Grid_Contenedor cross_start Grid_Item Base-100 tablet-100">
              <div class="CL_Alerta_Codigo Padding-10 Grid_Item">
                <div class="CL_TXT_Texto_4 CL_TXT_Gris CL_TXT_Texto_Bold">Codigo para crear una tabla</div>
                <div class="CL_TXT_Texto_2 CL_TXT_Gris">El estilo de la tabla puede cambiar, tansolo hay que variar el nombre de la tabla.</div>
                <div class="CL_TXT_Texto_1">Ejemplo: .Tabla_Estilo_2,Tabla_Estilo_3,Tabla_Estilo_4 etc..</div>
                <pre lang="pung"><code>.Tabla_Estilo_1
	table
		thead
			tr
				th # 
		...
		.Grid_Contenedor.abcenter.CON_Paginacion
			.Grid_Contenedor.Base-10
				p.CL_TXT_Texto_2.CL_TXT_Gris Pag&iacute;na: {{currentPage}}
			.Grid_Contenedor.Base-5
				input.Input_Estilo_1.No_Margin(type="number",min="1",max="100",ng-model="pageSize")<br/>			dir-pagination-controls.Base-45.cross_end.Grid_Contenedor(boundary-links="true",pagination-id="Ejemplo_Paginacion")
				p.CL_TXT_Texto_3.CL_TXT_Gris {{currentPage}}
		...
		tbody
			tr(dir-paginate="Ejemplo in Ejemplo_Array  | itemsPerPage: pageSize" current-page="currentPage",pagination-id="Ejemplo_Paginacion")
				td.CL_TXT_Texto_3.CL_TXT_Gris {{Ejemplo.NUM_ID_Mensaje}}
				td.CL_TXT_Texto_3.CL_TXT_Gris {{Ejemplo.TXT_Nombre_Usuario}}<br/>				td.CL_TXT_Texto_3.CL_TXT_Gris {{Ejemplo.TXT_Mensaje}}<br/>				td.CL_TXT_Texto_3.CL_TXT_Gris {{Ejemplo.DATE_Hora_Envio}}</code></pre>
              </div>
            </div>
          </li>
          <li class="CL_Diseno">
            ...
            <div class="Grid_Contenedor cross_start">
              <div class="Grid_Contenedor cross_start Grid_Item Base-100 tablet-50"><img src="http://lorempixel.com/90/90/" class="CL_Imagen_1"/><img src="http://lorempixel.com/90/90/" class="CL_Imagen_2"/><img src="http://lorempixel.com/90/90/" class="CL_Imagen_3"/><img src="http://lorempixel.com/90/90/" class="CL_Imagen_4"/></div>
              <div class="Grid_Contenedor cross_start Grid_Item Base-100 tablet-50">
                <div class="CL_Alerta_Codigo Padding-10 Grid_Item">
                  <div class="CL_TXT_Texto_4 CL_TXT_Gris CL_TXT_Texto_Bold">Codigo para aplicar estilos a una imagen</div>
                  <pre lang="pung"><code>img.CL_Imagen_1(src="#")
img.CL_Imagen_2(src="#")
img.CL_Imagen_3(src="#")
img.CL_Imagen_4(src="#")</code></pre>
                </div>
              </div>
            </div>
          </li>
          <li class="CL_Diseno">
            ...
            <div class="Grid_Contenedor cross_start">
              ...
              <div class="Grid_Contenedor cross_start Grid_Item Base-100 tablet-50">
                <div class="CL_Alerta_Codigo Padding-10 Grid_Item">
                  <div class="CL_TXT_Texto_4 CL_TXT_Gris CL_TXT_Texto_Bold">Codigo para crear contenedores tipo alerta</div>
                  <pre lang="pung"><code>p.CL_Alerta_5.Padding-10 Texto de prueba para la alerta
p.CL_Alerta_5.Padding-10 Texto de prueba para la alerta
p.CL_Alerta_3.Padding-10 Texto de prueba para la alerta
p.CL_Alerta_4.Padding-10 Texto de prueba para la alerta
p.CL_Alerta_5.Padding-10 Texto de prueba para la alerta
p.CL_Alerta_6.Padding-10 Texto de prueba para la alerta</code></pre>
                </div>
              </div>
            </div>
          </li>
          <li class="CL_Diseno">
            ...
            <div class="Grid_Contenedor cross_start">
              ...
              <div class="Grid_Contenedor cross_start Grid_Item Base-100 tablet-50">
                <div class="CL_Alerta_Codigo Padding-10 Grid_Item">
                  <div class="CL_TXT_Texto_4 CL_TXT_Gris CL_TXT_Texto_Bold">Codigo para tipo check</div>
                  <div class="CL_TXT_Texto_2 CL_TXT_Gris">!Nota¡, Para poder agregar varios check en una pagina se debera de usar diferentes id para el label, esto se logra cambiando el id, se debera de asignar un numero al final del id, ejemplo: INPUT_Chek_Recordatorio1,INPUT_Chek_Recordatorio2,INPUT_Chek_Recordatorio3 etc</div>
                  <pre lang="pung"><code>.CL_Check_Box_1
	input#INPUT_Chek_Recordatorio.Btn_CheckBox(type="checkbox")
	.CL_Check_Box_Remplazo
	label.CL_TXT_Chek_Box_Remplazo(for="INPUT_Chek_Recordatorio") Recordar mis datos</code></pre>
                </div>
              </div>
            </div>
          </li>
          ...
          <div class="Base-100 tablet-100">
            <li class="CL_Diseno">
              <p class="icon-list-alt CL_Txt_1">Modales</p>
              <div class="Grid_Contenedor cross_start">
                <div class="Grid_Contenedor">
                  <div class="CL_ALerta_2 Padding-10"></div>
                  <div ng-click="FN_Modal_Largo()" class="Btn_Estilo_7">Modal largo</div>
                  <div ng-click="FN_Modal_Corto()" class="Btn_Estilo_7">Modal corto</div>
                </div>
                <div class="Grid_Contenedor cross_start Grid_Item Base-100 tablet-50">
                  <div class="CL_Alerta_Codigo Padding-10 Grid_Item">
                    <div class="CL_TXT_Texto_4 CL_TXT_Gris CL_TXT_Texto_Bold">Codigo para un modal tipo largo</div>
                    <pre lang="pung"><code>section#Modales(ng-show="BL_Modal_Largo == true")
	section#CONT_Modal_Largo.Grid_Contenedor.abcenter
		.Grid_Contenedor.CL_CON_Modal_Largo.Base-90.tablet-80.web-70
			#CONT_Invisible(ng-click="FN_Modal_Largo()")
				.CL_Cerrar_Modal
			.Grid_Contenedor.CL_Cont_Contenido_Modal_Largo.Grid_Item
				.Grid_Contenedor.CL_Cont_Cabezera_Modal_Largo.relative.abcenter
					p.CL_TXT_Texto_4.CL_TXT_Gris Titulo modal
					p.CL_Eliminar_1_1(ng-click="FN_Modal_Largo()")
				.Grid_Contenedor.CL_Cont_Contenedio_Modal_Largo.cross_start
					p.CL_TXT_Texto_3.CL_TXT_Gris.CL_Segundo_Titulo_Modal_Largo Segundo titulo<br/>					.Grid_Contenedor.cross_start.CL_Cont_Info_Modal_Largo
						.Grid_Item
							p.CL_TXT_Texto_2.CL_TXT_Gris  Lorem ipsum dolor sit amet, consectetur adipisicing elit. Accusantium odit, ipsa voluptate blanditiis tempore, provident, aliquam est illum sequi temporibus laboriosam quaerat dicta minima! Cum dolorem nemo ut ad harum.
					.Grid_Contenedor.main_end.CL_Footer_Botones_Modal_Largo
						.Btn_Estilo_5(ng-click="FN_Modal_Largo()") Cerrar
						.Btn_Estilo_1(ng-click="CrearAlert(1);FN_Modal_Largo()") Confirmar</code></pre>
                  </div>
                </div>
                <div class="Grid_Contenedor cross_start Grid_Item Base-100 tablet-50">
                  <div class="CL_Alerta_Codigo Padding-10 Grid_Item">
                    <div class="CL_TXT_Texto_4 CL_TXT_Gris CL_TXT_Texto_Bold">Codigo para un modal tipo corto</div>
                    <pre lang="pung"><code>section#Modales(ng-show="BL_Modal_Corto == true")
	section#CONT_Modal_Corto.Grid_Contenedor.abcenter
		.Grid_Contenedor.CL_CON_Modal_Corto.Base-90.tablet-50.web-30
			#CONT_Invisible(ng-click="FN_Modal_Corto()")
				.CL_Cerrar_Modal
			.Grid_Contenedor.CL_Cont_Contenido_Modal_Corto.Grid_Item
				.Grid_Contenedor.CL_Cont_Cabezera_Modal_Corto.relative.abcenter
					p.CL_TXT_Texto_4.CL_TXT_Gris Titulo modal
					p.CL_Eliminar_1_1(ng-click="FN_Modal_Corto()")
				.Grid_Contenedor.CL_Cont_Contenedio_Modal_Corto.cross_start
					p.CL_TXT_Texto_3.CL_TXT_Gris.CL_Segundo_Titulo_Modal_Corto Segundo titulo<br/>					.Grid_Contenedor.cross_start.CL_Cont_Info_Modal_Corto
						.Grid_Item
							p.CL_TXT_Texto_2.CL_TXT_Gris  Lorem ipsum dolor sit amet, consectetur adipisicing elit. Accusantium odit, ipsa voluptate blanditiis tempore.
					.Grid_Contenedor.main_end.CL_Footer_Botones_Modal_Corto
						.Btn_Estilo_5(ng-click="FN_Modal_Corto()") Cerrar
						.Btn_Estilo_1(ng-click="CrearAlert(1);FN_Modal_Corto()") Confirmar</code></pre>
                  </div>
                </div>
              </div>
            </li>
  ...
  <section id="Ejemplo_Registro" ng-if="Conexion == true" class="ng_show">
    <div ng-controller="Controlador_Ejemplo_Crud" class="Tablero_Trabajo_1">
          ...
          <div ng-class="{Barra_Izquierda_Oculto:BL_Ocultar_Barra_Izquierda == true, BL_Ocultar_Barra_Izquierda:BL_Ocultar_Barra_Derecha == true}" class="Grid_Contenedor Base-40 cross_start CL_CONT_Tablero">
            <div class="CL_Cabezera_Tablero_Trabajo Grid_Contenedor Base-100 relative">
              <div class="Grid_Item Base-auto">
                <div class="margin_left-50 CL_TXT_Texto_5 icon-android-checkbox CL_TXT_Gris CL_TXT_Icon_Gris">CRUD </div>
            ...
            <div class="Grid_Contenedor Base-100 CL_CONT_Tablero_Trabajo_1">
              <div class="Grid_Contenedor Base-90 CL_Informacion_Tablero_1 abcenter">
                <div id="FORM_Registro_Ejemplo" ng-init="FN_Listar_Ejemplo()" ng-class="{CL_Registro_Base_50:BL_Ocultar_Barra_Izquierda == false, CL_Registro_Base_100:BL_Ocultar_Barra_Derecha == false}" class="Grid_Item abcenter Grid_Contenedor">
                  <div class="Grid_Item Base-90 Padding-5">
                    <form name="Ejemplo_Registro" ng-submit="FN_Registrar_Ejemplo(Ejemplo)">
                      ...
                      <label for="Nombre_Usuario_Ejemplo" class="CL_TXT_Texto_3 CL_TXT_Gris">Nombre</label>
                      ...
                      <label for="Contrasenia_Ejemplo" class="CL_TXT_Texto_3 CL_TXT_Gris">Contraseña</label>
          ...
          <div ng-class="{Barra_Derecho_Oculto:BL_Ocultar_Barra_Derecha == true,Barra_Derecho_Desplegado: BL_Ocultar_Barra_Izquierda == true}" class="Grid_Contenedor Base-60 cross_start CL_CONT_Tablero_Trabajo_2">
            <div class="CL_Cabezera_Tablero_Trabajo Grid_Contenedor Base-100 border_bottom_1">
              ...
              <div class="Grid_Item Base-100 Grid_Contenedor abcenter">
                <div class="CL_TXT_Texto_4 CL_TXT_Gris margin_left-50 icon-crop CL_TXT_Icon_Gris"> Prueba de crud con Php y Angular.js</div>
              </div>
            </div>
            <div class="Grid_Contenedor abcenter">
              <div class="Grid_Contenedor Base-95">
                <div class="Grid_Contenedor">
                  <div id="FORM_Registro_Ejemplo" class="Grid_Item Base-100">
                      ...
                      <div class="Tabla_Estilo_1">
                        <table>
                          ...
                          <div class="Grid_Contenedor abcenter CON_Paginacion">
                            ...
                            <dir-pagination-controls boundary-links="true" class="Base-50 cross_end Grid_Contenedor">
                              <p class="CL_TXT_Texto_3 CL_TXT_Gris">{{currentPage}}</p>
                              <ul ng-if="1 &lt; pages.length || !autoHide" class="main_end CL_Paginacion_1 Grid_Contenedor">
                                <li ng-if="boundaryLinks" ng-class="{ Paginacion_Disabled : pagination.current == 1 }"><a href="" ng-click="setCurrent(1)">&laquo;</a></li>
                                <li ng-if="directionLinks" ng-class="{ Paginacion_Disabled : pagination.current == 1 }"><a href="" ng-click="setCurrent(pagination.current - 1)">&lsaquo;</a></li>
                          ...
                          <tbody>
                            <tr dir-paginate="Lista_Ejemplo in AOBJ_Lista_Ejemplo | filter:Buscador_Usuario | itemsPerPage: pageSize" current-page="currentPage">
                              <td class="CL_Imagen">
                              ...
                              <td class="CL_Tbl_Icon">
                                <button ng-disabled="!Form_Lista.$valid" ng-class="{Invisible:BL_Edicion_Datos == false, Visible: BL_Edicion_Datos == true}" ng-click="BL_Edicion_Datos =!BL_Edicion_Datos; FN_Modificar_Ejemplo(Lista_Ejemplo.PK_ID_Usuario_Ejemplo)" value="Actualizar" class="CL_TXT_Pri_Btn relative icon-actualizar"><span class="CL_TXT_Info_Btn">Actualizar</span></button>
                              ...
                              <td class="CL_Tbl_Icon">
                                <div ng-click="FN_Eliminar_Ejemplo(Lista_Ejemplo.PK_ID_Usuario_Ejemplo)" class="icon-cancelar2 CL_TXT_Pri_Btn relative"><span class="CL_TXT_Info_Btn">Eliminar</span></div>
                              </td>
                            </tr>
                          </tbody>
                        </table>
                      </div>
                      <div ng-show="(AOBJ_Lista_Ejemplo |filter:Buscador_Usuario:Lista_Ejemplo.Nombre_Usuario_Ejemplo).length == 0" class="CL_Alerta_5 ng_repeat_anim1 Grid_Contenedor abcenter">
                        <div class="CL_TXT_Texto_3 CL_TXT_Gris Base-100 Grid_Item abcenter Padding-10">No se han encontrado usuarios</div>
                      </div>
                    </form>
                  </div>
                </div>
  ...
  <section id="Ejemplo_Registro" ng-if="Cuerpo_Tabla == true" class="ng_show">
      ...
      <div class="Grid_Contenedor Base-100 abcenter CL_CONT_Principal_Tablero_Trabajo">
        <div ng-init="BL_Ocultar_Barra_Izquierda = false;BL_Ocultar_Barra_Derecha = false" class="Grid_Contenedor Base-100 CL_CONT_Tablero_Trabajo">
          <div ng-class="{Barra_Izquierda_Oculto:BL_Ocultar_Barra_Izquierda == true, BL_Ocultar_Barra_Izquierda:BL_Ocultar_Barra_Derecha == true}" class="Grid_Contenedor Base-40 cross_start CL_CONT_Tablero">
            <div class="CL_Cabezera_Tablero_Trabajo Grid_Contenedor Base-100 relative">
              <div class="Grid_Item Base-auto">
                <div class="margin_left-50 CL_TXT_Texto_5 icon-android-checkbox CL_TXT_Gris CL_TXT_Icon_Gris">Tablero  </div>
                <p ng-show="BL_Ocultar_Barra_Derecha == true" ng-click="BL_Ocultar_Barra_Derecha =! BL_Ocultar_Barra_Derecha" title="Cerrar el panel de la izquierda" class="absolute left-10 top-5_5 Enlace icon-puzzle-piece ng_show CL_TXT_Icon_Azul"></p>
                <p ng-show="BL_Ocultar_Barra_Derecha == false " ng-click="BL_Ocultar_Barra_Derecha =! BL_Ocultar_Barra_Derecha" title="Cerrar el panel de la izquierda" class="absolute left-10 top-5_5 Enlace icon-minus-1 ng_show CL_TXT_Icon_Rojo_2"></p>
              </div>
            </div>
          ...
          <div ng-class="{Barra_Derecho_Oculto:BL_Ocultar_Barra_Derecha == true,Barra_Derecho_Desplegado: BL_Ocultar_Barra_Izquierda == true}" class="Grid_Contenedor Base-60 cross_start CL_CONT_Tablero_Trabajo_2">
            <div class="CL_Cabezera_Tablero_Trabajo Grid_Contenedor Base-100 border_bottom_1">
              ...
              <div class="Grid_Item Base-100 Grid_Contenedor abcenter">
                <div class="CL_TXT_Texto_4 CL_TXT_Gris margin_left-50">Titulo</div>
              </div>
            </div>
            <div class="Grid_Contenedor abcenter">
              <div class="Grid_Contenedor Base-95">
                <div class="CL_Alerta_5 Grid_Contenedor">
                  ...
                  <div class="Grid_Item Base-40 Grid_Contenedor abcenter">
                    <div class="CL_TXT_Texto_4 CL_TXT_Gris">Titulo</div>
                  </div>
    ...
    <div class="Grid_Contenedor abcenter">
      <div class="CL_Alerta_Codigo Padding-10 Base-100 tablet-60 Grid_Item">
        <div class="CL_TXT_Texto_4 CL_TXT_Gris CL_TXT_Texto_Bold">Codigo para crear el tablero</div>
        <pre lang="pung"><code>.Tablero_Trabajo_1
	.Grid_Contenedor.Base-100.abcenter.CL_CONT_Principal_Tablero_Trabajo()
		.Grid_Contenedor.Base-90.CL_CONT_Tablero_Trabajo()
			.Grid_Contenedor.Base-30.cross_start.CL_CONT_Tablero
				...
				.Grid_Contenedor.CL_CONT_Buscador_Tablero_Trabajo.abcenter
					.Grid_Contenedor.abcenter.Base-90
						.CL_Contenedor_Buscador(ng-init="Buscar")
							input.CL_Buscar#Buscar(maxlength="15",type="search", name="Buscar" placeholder="Buscar" ng-model="Buscar")
							label.icon-buscar.CL_Icono_Buscar(for="Buscar")
				.Grid_Contenedor.Base-100.cross_start.CL_CONT_Tablero_Trabajo_1
					.Grid_Contenedor.Base-90.CL_Informacion_Tablero_1.cross_start
						.CL_Alerta_1.Padding-10 Formulario, listas<br/>					//Por si se usa un filtro
					.CL_Alerta_5.ng_repeat_anim1.Grid_Contenedor(ng-show="(Lista_Datos_Ejemplo |filter:Buscar:Item).length == 0")
						.CL_TXT_Texto_3.CL_TXT_Gris.Base-100.abcenter.Grid_Contenedor
							p Dato no encontrado
			.Grid_Contenedor.Base-70.cross_start.CL_CONT_Tablero_Trabajo_2
				.CL_Cabezera_Tablero_Trabajo.Grid_Contenedor.Base-100<br/>					.Grid_Item.Base-100.Grid_Contenedor.abcenter
						.CL_TXT_Texto_4.CL_TXT_Gris Titulo
				.Grid_Contenedor.abcenter
					.Grid_Contenedor.Base-95
						.CL_Alerta_5.Grid_Contenedor
							.Grid_Item.Base-20
								img.CL_Imagen_Icono_1(ng-src="{{dato.AOBJ_Datos_Usuario[0].Imagen_Usuario}}")
							.Grid_Item.Base-40.Grid_Contenedor.abcenter
								.CL_TXT_Texto_4.CL_TXT_Gris Titulo
							.Grid_Item.Base-40.relative
								p.CL_Eliminar_1_1
						.Grid_Contenedor
							.CL_Alerta_1.Padding-10 Formulario, listas</code></pre>
      </div>
    </div>
  </section>
  <section id="Modales" ng-show="BL_Modal_Largo == true">
    <section id="CONT_Modal_Largo" class="Grid_Contenedor abcenter">
      <div class="Grid_Contenedor CL_CON_Modal_Largo Base-90 tablet-80 web-70">
        <div id="CONT_Invisible" ng-click="FN_Modal_Largo()">
          <div class="CL_Cerrar_Modal"></div>
        </div>
        <div class="Grid_Contenedor CL_Cont_Contenido_Modal_Largo Grid_Item">
          <div class="Grid_Contenedor CL_Cont_Cabezera_Modal_Largo relative abcenter">
            <p class="CL_TXT_Texto_4 CL_TXT_Gris">Titulo modal</p>
            <p ng-click="FN_Modal_Largo()" class="CL_Eliminar_1_1"></p>
          </div>
          <div class="Grid_Contenedor CL_Cont_Contenedio_Modal_Largo cross_start">
            <p class="CL_TXT_Texto_3 CL_TXT_Gris CL_Segundo_Titulo_Modal_Largo">Segundo titulo</p>
            <div class="Grid_Contenedor cross_start CL_Cont_Info_Modal_Largo">
              <div class="Grid_Item">
                <p class="CL_TXT_Texto_2 CL_TXT_Gris"> Lorem ipsum dolor sit amet, consectetur adipisicing elit. Accusantium odit, ipsa voluptate blanditiis tempore, provident, aliquam est illum sequi temporibus laboriosam quaerat dicta minima! Cum dolorem nemo ut ad harum.</p>
              </div>
            </div>
            <div class="Grid_Contenedor main_end CL_Footer_Botones_Modal_Largo">
              <div ng-click="FN_Modal_Largo()" class="Btn_Estilo_5">Cerrar</div>
              <div ng-click="CrearAlert(1);FN_Modal_Largo()" class="Btn_Estilo_1">Confirmar</div>
            </div>
          </div>
        </div>
      </div>
  ...
  <section id="Modales" ng-show="BL_Modal_Corto == true">
    <section id="CONT_Modal_Corto" class="Grid_Contenedor abcenter">
      <div class="Grid_Contenedor CL_CON_Modal_Corto Base-90 tablet-50 web-30">
        <div id="CONT_Invisible" ng-click="FN_Modal_Corto()">
          <div class="CL_Cerrar_Modal"></div>
        </div>
        <div class="Grid_Contenedor CL_Cont_Contenido_Modal_Corto Grid_Item">
          <div class="Grid_Contenedor CL_Cont_Cabezera_Modal_Corto relative abcenter">
            <p class="CL_TXT_Texto_4 CL_TXT_Gris">Titulo modal</p>
            <p ng-click="FN_Modal_Corto()" class="CL_Eliminar_1_1"></p>
          </div>
          <div class="Grid_Contenedor CL_Cont_Contenedio_Modal_Corto cross_start">
            <p class="CL_TXT_Texto_3 CL_TXT_Gris CL_Segundo_Titulo_Modal_Corto">Segundo titulo</p>
            <div class="Grid_Contenedor cross_start CL_Cont_Info_Modal_Corto">
              <div class="Grid_Item">
                <p class="CL_TXT_Texto_2 CL_TXT_Gris"> Lorem ipsum dolor sit amet, consectetur adipisicing elit. Accusantium odit, ipsa voluptate blanditiis tempore.</p>
              </div>
            </div>
            <div class="Grid_Contenedor main_end CL_Footer_Botones_Modal_Corto">
              <div ng-click="FN_Modal_Corto()" class="Btn_Estilo_5">Cerrar</div>
              <div ng-click="CrearAlert(1);FN_Modal_Corto()" class="Btn_Estilo_1">Confirmar</div>
            </div>
          </div>
        </div>
      </div>
