...
public function Modulo_Pedido(){
    // Basicos para la web
    require APP . 'view/_Templates/header.php';
    //Contenido propio de la vista
    require APP . 'view/Administracion/Modulo_Pedido/index.php';
    //Modulos implementados
    // require APP . 'view/_Templates/Modulos/Modulo_Notificaciones.php';
    require APP . 'view/_Templates/Modulos/Modulo_Chat.php';
    // require APP . 'view/_Templates/Modulos/Modulo_Pedido.php';
...
public function Modulo_Mensajes(){
    // Basicos para la web
    require APP . 'view/_Templates/header.php';
    //Contenido propio de la vista
    require APP . 'view/Administracion/Modulo_Mensajes/index.php';
    //Modulos implementados
    // require APP . 'view/_Templates/Modulos/Modulo_Notificaciones.php';
    require APP . 'view/_Templates/Modulos/Modulo_Chat.php';
    // require APP . 'view/_Templates/Modulos/Modulo_Pedido.php';
...
public function Modulo_Ruta(){
    ...
    require APP . 'view/_Templates/header.php';
    //Contenido propio de la vista
    require APP . 'view/Administracion/Modulo_Ruta/index.php';
    //Modulos implementados
    // require APP . 'view/_Templates/Modulos/Modulo_Notificaciones.php';
    require APP . 'view/_Templates/Modulos/Modulo_Chat.php';
    // require APP . 'view/_Templates/Modulos/Modulo_Pedido.php';
...
public function Modulo_Chat(){
    // Basicos para la web
    require APP . 'view/_Templates/header.php';
    //Contenido propio de la vista
    require APP . 'view/Administracion/Modulo_Chat/index.php';
    //Modulos implementados
    // require APP . 'view/_Templates/Modulos/Modulo_Notificaciones.php';
    require APP . 'view/_Templates/Modulos/Modulo_Chat.php';
    // require APP . 'view/_Templates/Modulos/Modulo_Pedido.php';
