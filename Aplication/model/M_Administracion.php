...
class M_Administracion {
  ...
  */
    public function FN_Registrar_TBL_Empleado(
      ...
      $query->bindParam(7, $Telefono_Celular);
  ...
  */
      public function FN_Listar_Usuarios($PK_ID_Rol) {
  ...
  */
    ...
    {
      $sql = "CALL `spActualizarTipo_Cliente`(?,?,?);";
      $query = $this->db->prepare($sql);
      $query->bindParam(1, $PK_ID_Usuario);
      $query->bindParam(2,$Tipo_Cliente);
      $query->bindParam(3,$Verificacion_Cuenta);
