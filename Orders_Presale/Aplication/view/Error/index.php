...
<title>{{dato.AOBJ_Datos_Usuario[0].Nombre_Usuario}} | Error</title>
...
<section id="SC_Error">
  <main id="CONT_E_Error">
    <p class="CL_TXT_E_Titulo">OOPS!</p>
    <p class="CL_TXT_E_Texto"> La pag&iacute;na solicitada no ha sido encontrada, parece que te has perdido</p><a href="<?php echo URL;?>Inicio/Inicio" class="icon-inicio Btn_Estilo_5">Volver a inicio</a>
  </main>
  <style media="screen">
    <?php
    $valor = rand(0,4);
