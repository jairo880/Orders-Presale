...
<html lang="es" ng-app="AppOrders_Presale">
  <head>
    ...
    <script src="<?php echo URL;?>public/js/Angular/Librerias/angular-locale_es-cl.js"></script>
    <script src="<?php echo URL;?>public/js/Angular/Librerias/ngStorage.min.js"></script>
    <script src="<?php echo URL;?>public/js/Angular/Librerias/dirPagination.js"></script><script>
  ...
  <header id="CONT_Header_Web_Page" ng-class="{CL_Header_Menu_Oculto: Bl_Menu_Desplegado, CL_Header_Menu_Desplegado: ! Bl_Menu_Desplegado}">
    ...
    <div id="CONT_Btns_Header">
      ...
      <div class="CL_Btns_Menu">
        ...
        <!--Elemento visible solo para usuarios y usuario sin iniciar sesion-->
        <div ng-init="BL_Btns_Ver_Notificaciones = false" ng-click="FN_Notificacion()" title="Desplegar menu de notificaciones" ng-if="dato.AOBJ_Datos_Usuario[0].FK_ID_Rol == 3 " class="CL_Btn_Herramientas_Header CL_TXT_Pri_Btn">
          <div class="CL_CONT_Contenedor_Btns_Opcion">
        ...
        <!--Elemento visible solo para usuarios y usuario sin iniciar sesion-->
        <div ng-init="BL_Btns_Ver_Mensajes = false" ng-click="FN_Mensaje_Desplegar(true,false,false,false,false)" title="Desplegar menu de mensajes" ng-if="dato.AOBJ_Datos_Usuario[0].FK_ID_Rol == 3  " class="CL_Btn_Herramientas_Header CL_TXT_Pri_Btn">
          <div class="CL_CONT_Contenedor_Btns_Opcion">
        ...
        <!--Elemento visible solo para usuarios y usuario sin iniciar sesion-->
        <div ng-init="BL_Btns_Ver_Ordenes_Enviadas = false" ng-click="FN_Ordenes_Enviadas(2)" title="Desplegar menu de ordenes enviadas" ng-if="dato.AOBJ_Datos_Usuario[0].FK_ID_Rol == 3" class="CL_Btn_Herramientas_Header CL_TXT_Pri_Btn">
          <div class="CL_CONT_Contenedor_Btns_Opcion">
            <p class="icon-check-clipboard-1"></p><span class="CL_TXT_Info_Btn">Ordenes enviadas</span>
          </div>
        </div>
        <div ng-click="FN_Opciones_Cuenta_Header()" title="Desplegar opciones perfil" class="CL_Btn_Herramientas_Header CL_TXT_Pri_Btn">
