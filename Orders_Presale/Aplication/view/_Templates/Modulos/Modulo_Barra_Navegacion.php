        ...
        <div id="CONT_Portada"><img ng-src="{{dato.AOBJ_Datos_Usuario[0].Fondo_Perfil_Usuario}}" class="CL_Portada_Imagen"/>
          <div id="CONT_Datos_Cuenta">
            <div id="CONT_Imagen_Perfil">
              <div class="CL_Imagen_Perfil"><img ng-src="{{dato.AOBJ_Datos_Usuario[0].Imagen_Usuario}}" class="CL_Img_Perfil"/><span ng-if="BL_Btns_Ver_Login == false;Bl_Btn_Login_Iniciar_Sesion == false" ng-class="{Activo: dato.AOBJ_Datos_Usuario[0].Disponibilidad == 'Activo', Inactivo:  dato.AOBJ_Datos_Usuario[0].Disponibilidad == 'Inactivo'}" title="Estado actual de tu cuenta" class="Estado_Usuario">
                  <p></p></span></div>
            </div>
            <div id="CONT_Datos_Usuario">
              ...
              <div id="CONT_Herramientas_Usuario" ng-if="BL_Btns_Ver_Login == false;Bl_Btn_Login_Iniciar_Sesion == false">
          ...
          <ul id="CONT_Ul_Nav" ng-init="BL_Gestion_Cuentas_Usuario = false;BL_Gestion_Administrativa=false">
            <section id="CONT_SC_Paginas">
              ...
              <div ng-if="dato.AOBJ_Datos_Usuario[0].FK_ID_Rol == 3 || dato.AOBJ_Datos_Usuario[0].FK_ID_Rol == 5 ">
                ...
                <li class="Grid_Contenedor abcenter"><a ng-click="FN_Mensaje_Desplegar(true,true,false,false,true)" class="CL_Btn_Enlace icon-ayuda-online"><span class="CL_TXT_Nav">Ayuda</span></a></li>
            ...
            <section id="CONT_SC_Herramientas">
              ...
              <div ng-if="dato.AOBJ_Datos_Usuario[0].FK_ID_Rol == 3 || dato.AOBJ_Datos_Usuario[0].FK_ID_Rol == 5 ">
                <li class="Grid_Contenedor abcenter"><a ng-click="FN_Mensaje_Desplegar(true,false,false,false,false)" class="CL_Btn_Enlace icon-mensaje"><span class="CL_TXT_Nav">Mensajes</span><span class="CL_Cantidad">{{dato.NUM_CantidadMensajeUsuario}}</span></a></li>
                <li class="Grid_Contenedor abcenter"><a ng-click="FN_Notificacion()" class="CL_Btn_Enlace icon-notificacion"><span class="CL_TXT_Nav">Notificaciones</span><span class="CL_Cantidad"> {{dato.NUM_CantidadNotificaciones}}</span></a></li>
                <li class="Grid_Contenedor abcenter"><a ng-click="FN_Orden()" title="Desplegar menu de orden" class="CL_Btn_Enlace icon-orden"><span class="CL_TXT_Nav">Mi orden actual</span><span class="CL_Cantidad"> {{dato.NUM_Cantidad_Productos_En_Orden}}</span></a></li>
                <li ng-click="FN_Ordenes_Enviadas()" title="Desplegar menu de ordenes enviadas" ng-if="dato.AOBJ_Datos_Usuario[0].FK_ID_Rol == 3" class="Grid_Contenedor abcenter"><a ng-click="FN_Ordenes_Enviadas(2)" title="Desplegar menu de ordenes enviadas" class="CL_Btn_Enlace icon-check-clipboard-1"><span class="CL_TXT_Nav">Ordenes enviadas</span></a></li>
              </div>
            ...
            <section id="CONT_SC_Herramientas" ng-if="dato.AOBJ_Datos_Usuario[0].FK_ID_Rol == 1">
              <div>
                <p class="CL_TXT_Detalle">Opciones</p>
                <li class="Grid_Contenedor abcenter"><a href="<?php echo URL; ?>Administracion/Inicio_Administracion/Modulo_Producto" class="CL_Btn_Enlace icon-puzzle-piece"><span class="CL_TXT_Nav">M&oacute;dulo producto</span></a></li>
                <li class="Grid_Contenedor abcenter"><a href="<?php echo URL; ?>Administracion/Inicio_Administracion/Modulo_Promociones" class="CL_Btn_Enlace icon-puzzle-piece"><span class="CL_TXT_Nav">M&oacute;dulo promociones</span></a></li>
                <li class="Grid_Contenedor abcenter"><a href="<?php echo URL; ?>Administracion/Inicio_Administracion/Modulo_Categoria" class="CL_Btn_Enlace icon-puzzle-piece"><span class="CL_TXT_Nav">M&oacute;dulo categoria</span></a></li>
                <li class="Grid_Contenedor abcenter"><a href="<?php echo URL; ?>Administracion/Inicio_Administracion/Modulo_Gestion_De_Contenido" class="CL_Btn_Enlace icon-puzzle-piece"><span class="CL_TXT_Nav">M&oacute;dulo gestion de contenido</span></a></li>
              </div>
            </section>
            <!--Elemento visible solo para Administradores-->
            <section id="CONT_SC_Paginas" ng-if="dato.AOBJ_Datos_Usuario[0].FK_ID_Rol == 1">
              <li class="Grid_Contenedor abcenter"><a href="<?php echo URL; ?>Administracion/Inicio_Administracion/Modulo_Permisos_Usuario" class="CL_Btn_Enlace icon-puzzle-piece"><span class="CL_TXT_Nav">M&oacute;dulo permisos usuario</span></a></li>
              <li class="Grid_Contenedor abcenter"><a href="<?php echo URL; ?>Administracion/Inicio_Administracion/Modulo_Cotizacion" class="CL_Btn_Enlace icon-puzzle-piece"><span class="CL_TXT_Nav">M&oacute;dulo cotizaci&oacute;n</span></a></li>
    ...
    <div id="CONT_Perfil_Opciones_Usuario_P" ng-show="BL_Opciones_Cuenta == true">
      ...
      <div class="CL_Mas_Opciones_Cuenta">
        ...
        <div ng-if="dato.AOBJ_Datos_Usuario[0].FK_ID_Rol == 3 || dato.AOBJ_Datos_Usuario[0].FK_ID_Rol == 5 ">
          ...
          <div ng-click="FN_Ordenes_Enviadas(2)" title="Desplegar menu de ordenes enviadas" ng-if="dato.AOBJ_Datos_Usuario[0].FK_ID_Rol == 3" class="CL_Opciones_Cuenta">
