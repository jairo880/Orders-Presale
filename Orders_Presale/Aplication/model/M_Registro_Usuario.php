...
class M_Registro_Usuario {
  ...
  if ($query->rowCount() > 0) {
    ...
    public function FN_Registrar_TBL_Cliente(
        $FK_ID_Cuenta, $Nombre, $Segundo_Nombre, $Apellido, $Segundo_Apellido, $Municipio, $Fecha_Nacimiento, $Telefono_Celular, $Sexo, $Tipo_Cliente, $Posee_Empresa
        ) {
  ...
  /**
  * Consultar si   el correo electronico  existe en la base de datos
  * @param 
  */
