...
CREATE TABLE IF NOT EXISTS TBL_Cuenta (
  ...
  Fecha_Creacion_Cuenta DATETIME DEFAULT now(),
  Tipo_Cliente VARCHAR(45) DEFAULT "Esporadico",
  FK_ID_Rol INT(45) NOT NULL,
  Verificacion_Cuenta VARCHAR(45) DEFAULT "Por_Verificar",
...
CREATE TABLE IF NOT EXISTS TBL_Pedido_Usuario (
  ...
  Fecha_Cotizacion Datetime NOT NULL,
  Estado_pedido VARCHAR(40) NOT NULL DEFAULT 'En proceso',
  FK_ID_Usuario INT(45) NOT NULL,
  Telefono_Entrega  VARCHAR(45) NOT NULL,
...
CREATE TABLE IF NOT EXISTS TBL_Producto (
  ...
  Valoracion_Producto INT(45) NOT NULL DEFAULT 0,
  PRIMARY KEY (PK_ID_Producto),
  FOREIGN KEY (FK_ID_Categoria) REFERENCES TBL_Categoria_Producto (PK_ID_Categoria)
)ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT = 1;


-- Estructura par la tabla  TBL_DLL_Valoracion_Producto Producto
--
DROP TABLE IF EXISTS TBL_DLL_Valoracion_Producto;
CREATE TABLE IF NOT EXISTS TBL_DLL_Valoracion_Producto (
  PK_ID_Valoracion_Producto INT(45) NOT NULL AUTO_INCREMENT,
  FK_ID_Usuario INT(40) NOT NULL,
  FK_ID_Producto INT(45) NOT NULL,

  PRIMARY KEY (PK_ID_Valoracion_Producto),
  FOREIGN KEY (FK_ID_Producto) REFERENCES TBL_Producto(PK_ID_Producto),
  FOREIGN KEY (FK_ID_Usuario) REFERENCES TBL_Cuenta(PK_ID_Usuario)
)ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT= 1;
--
-- Estructura par la tabla  TBL_DLL_Producto_Cotizacion_Fija, esta tabla sirve para perseverar los datos de un pedido, aunque se cambien los precios del sistema, no cambiaran en esta tabla
--
DROP TABLE IF EXISTS TBL_DLL_Producto_Cotizacion_Fija;
CREATE TABLE IF NOT EXISTS TBL_DLL_Producto_Cotizacion_Fija (
 PK_ID_Producto_Cotizacion_Fija INT(45) NOT NULL AUTO_INCREMENT,
 Nombre_Producto VARCHAR(45) NOT NULL,
 Ruta_Imagen_Producto VARCHAR(250) NOT NULL,
 Valor_Unitario INT(30) NOT NULL,
 ...
 PRIMARY KEY (PK_ID_Producto_Cotizacion_Fija),
...
CREATE TABLE IF NOT EXISTS TBL_Promocion (
  ...
  Dias_Duracion INT(100) NOT NULL,
  Imagen_Promocion VARCHAR(250),
...
CREATE TABLE IF NOT EXISTS TBL_Buson_Mensajes_Usuario (
  ...
  FK_ID_Usuario_Destinatario INT(45) NOT NULL,
  FK_ID_Usuario_Remitente INT(45) NOT NULL,
  Estado_Mensaje VARCHAR(45) DEFAULT 'Registrado',
  PRIMARY KEY (PK_ID_Buson_Mensajes),
  FOREIGN KEY (FK_ID_Usuario_Destinatario) REFERENCES TBL_Cuenta(PK_ID_Usuario),
  FOREIGN KEY (FK_ID_Usuario_Remitente) REFERENCES TBL_Cuenta(PK_ID_Usuario)
...
DROP TABLE IF EXISTS TBL_Dll_Chat;
CREATE TABLE IF NOT EXISTS TBL_Dll_Chat(
  PK_ID_Dll_Chat INT(45) NOT NULL AUTO_INCREMENT,
  FK_ID_Usuario_Destinatario INT(45) NOT NULL,
  FK_ID_Usuario_Remitente INT(45) NOT NULL,
  Fecha_Inicio_Conversacion Datetime NOT NULL,
  PRIMARY KEY (PK_ID_Dll_Chat),
  FOREIGN KEY (FK_ID_Usuario_Destinatario) REFERENCES TBL_Cuenta(PK_ID_Usuario),
  FOREIGN KEY (FK_ID_Usuario_Remitente) REFERENCES TBL_Cuenta(PK_ID_Usuario)
...
CREATE TABLE IF NOT EXISTS TBL_Chat(
  PK_ID_Chat INT(45) NOT NULL AUTO_INCREMENT,
  FK_ID_Dll_Chat INT(45) NOT NULL,
  FK_ID_Usuario_Destinatario INT(45) NOT NULL,
  FK_ID_Usuario_Remitente INT(45) NOT NULL,
  Mensaje TEXT NOT NULL,
  Fecha_Envio Datetime NOT NULL,
  Estado_Mensaje VARCHAR(45) DEFAULT 'No_Visto',
  PRIMARY KEY (PK_ID_Chat),
  FOREIGN KEY (FK_ID_Usuario_Destinatario) REFERENCES TBL_Cuenta(PK_ID_Usuario),
  FOREIGN KEY (FK_ID_Usuario_Remitente) REFERENCES TBL_Cuenta(PK_ID_Usuario),
  FOREIGN KEY (FK_ID_Dll_Chat) REFERENCES TBL_Dll_Chat(PK_ID_Dll_Chat)
...
--
-- Estructura par la tabla  TBL_Listas_Ordenes_Usuario
--
DROP TABLE IF EXISTS TBL_Listas_Ordenes_Usuario;
CREATE TABLE IF NOT EXISTS TBL_Listas_Ordenes_Usuario (
  PK_ID_Lista_Usuario INT(45) NOT NULL AUTO_INCREMENT,
  FK_ID_Usuario INT(45) NOT NULL,
  Nombre_Lista VARCHAR(45) NOT NULL,
  Fecha_Creacion Datetime NOT NULL,
  PRIMARY KEY (PK_ID_Lista_Usuario),
  FOREIGN KEY (FK_ID_Usuario) REFERENCES TBL_Cuenta(PK_ID_Usuario)
...
--
-- Estructura par la tabla  TBL_DLL_Listas_Ordenes_Usuario
--
DROP TABLE IF EXISTS TBL_DLL_Listas_Ordenes_Usuario;
CREATE TABLE IF NOT EXISTS TBL_DLL_Listas_Ordenes_Usuario (
  PK_ID_DLL_Lista_Usuario INT(45) NOT NULL AUTO_INCREMENT,
  FK_ID_Producto INT(45) NOT NULL,
  FK_ID_Lista_Usuario INT(45) NOT NULL,
  ...
  Cant_Unid_Min INT(100) NOT NULL,
  Nombre_Producto VARCHAR(45) NOT NULL,
  PRIMARY KEY (PK_ID_DLL_Lista_Usuario),
  FOREIGN KEY (FK_ID_Producto) REFERENCES TBL_Producto(PK_ID_Producto),
  FOREIGN KEY (FK_ID_Lista_Usuario) REFERENCES TBL_Listas_Ordenes_Usuario(PK_ID_Lista_Usuario)
)ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=1;
